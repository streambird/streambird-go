...
// Client initializes a new Streambird client that uses the
func Client(t *testing.T) *streambird.Client {
	return client(t, "")
}

func client(t *testing.T, accessKey string) *streambird.Client {
	...
	client := streambird.New(accessKey)
